...
define config.name = _("the_accidental_architect_of_magic")
...
define build.name = "the_accidental_architect_of_magic"
...
define config.save_directory = "the_accidental_architect_of_magic-1779014498"

...
- route: common
- event: 리아 벨 아스트린의 대표 마도건축 구조물이 학원 내부 연구 발표회에서 붕괴 직전까지 불안정해짐.
- location: academy_demo_hall
- time: undecided
- mc_action: 주인공이 구조적 비틀림을 알아보고 설계선 또는 마력 흐름을 안정화함.
- result:
  - 구조물은 안정화된다.
  - 리아는 처음으로 웃음을 잃는다.
  - 교수진은 주인공을 정체불명의 위험한 인물로 본다.
  - 주인공은 자신이 한 일을 안전 조치 정도로 이해한다.
...
- meaning: 주인공이 자기 능력을 축소하고 상황을 피하려 한다.
